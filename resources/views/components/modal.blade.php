...
>
    ...
    <div
        x-show="show"
        class="relative w-full max-h-[90vh] bg-white dark:bg-dark-surface rounded-t-3xl lg:rounded-3xl overflow-hidden shadow-2xl transform transition-all {{ $maxWidth }}"
        x-transition:enter="ease-out duration-300"
